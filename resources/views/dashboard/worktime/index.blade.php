                                    ...
                                    <div class="card mb-5 mb-xl-8">
						        	     <div class="card-header border-0 pt-5">
								    	   ...
								    	   <div class="card-toolbar" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover">
									     	  <a href="{{route('worktimes.create')}}" class="btn btn-sm btn-light btn-active-primary">
										        ...
										        <div class="table-responsive">
										  	         <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
											  	         <thead>
                                                                ...
                                                                <th class="min-w-120px">{{__('admin.start_time')}}</th>
                                                                <th class="min-w-120px">{{__('admin.end_time')}}</th>
															     ...
															     <a href="#" class="btn btn-light btn-active-light-primary btn-sm" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end" data-kt-menu-flip="top-end">{{__('admin.actions')}}
															       ...
															       <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
																     <div class="menu-item px-3">
																        <a href="{{route('worktimes.edit', $time->id)}}" class="menu-link px-3">{{__('admin.edit')}}</a>
																     </div>
																      <div class="menu-item px-3">
															  	          <a href="#" class="menu-link px-3" data-bs-toggle="modal" data-bs-target="#kt_modal_1{{$time->id}}">{{__('admin.delete')}}</a>					
															 	      </div>
															       </div>
														        </td>
													        </tr>
			
												 	          <div id="kt_modal_1{{$time->id}}"  tabindex="-1" class="modal fade">
																				      ...
																				      <div class="modal-body text-center">
																					    <p>{{ __('admin.Areyousure')}}</p>
																					     ...
																					     <button type="button" class="btn btn-light" data-bs-dismiss="modal" style="position:relative;float:right;">{{__('admin.Close')}}</button>
																					      {!! Form::open(['url' => route('worktimes.destroy', $time->id), 'method' => 'delete']) !!}
