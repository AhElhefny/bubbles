...
@section('content')
            <div class="row g-5 g-xl-8">
                 <div class="col-xl-3">
                     <div class="card hoverable card-xl-stretch mb-xl-8 bg-danger">
                         <div class="card-body">
                            <span class="svg-icon svg-icon-white svg-icon-3x ms-n1">
                                <i class="fas fa-hospital text-light fs-2x"></i>
                            </span>
                            <div class="text-white fw-bolder fs-2 mb-2 mt-5">{{__('admin.branches')}}</div>
                                <div class="fw-bold text-white">{{count($branches)}}</div>
                          </div>
                      </div>
                 </div>

                  <div class="col-xl-3">
                       <div class="card  hoverable card-xl-stretch mb-xl-8 bg-success">
                           <div class="card-body">
                             <span class="svg-icon svg-icon-white svg-icon-3x ms-n1">
                                 <i class="fas fa-globe-africa  text-light fs-2x"></i>
                             </span>
                            <div class="text-white fw-bolder fs-2 mb-2 mt-5">{{__('admin.orders')}}</div>
                                 <div class="fw-bold text-white">{{count($orders)}}</div>
                            </div>
                          </div>
                    </div>
                </div>
                                        ...
                                        <div class="col bg-light-warning px-6 py-8 rounded-2 me-7 mb-7">
                                              <span class="svg-icon svg-icon-3x svg-icon-warning d-block my-2">
                                                 <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                       ...
                                                       <a href="{{url('vendor/services/create')}}" class="text-warning fw-bold fs-6">{{__('admin.addservice')}}</a>
                                                  </div>
                                                    ...
                                                    <div class="col bg-light-primary px-6 py-8 rounded-2 mb-7">
                                                         <span class="svg-icon svg-icon-3x svg-icon-primary d-block my-2">
                                                             ...
                                                             <a href="{{route('branches.create')}}" class="text-primary fw-bold fs-6">{{__('admin.addbranch')}}</a>
                                                          </div>
                                                     </div>
                                                 </div>
                                              </div>
