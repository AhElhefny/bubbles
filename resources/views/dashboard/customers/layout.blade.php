...
{{--                                                       @endif--}}
                    ...
                    <div class="d-flex overflow-auto h-55px">
                        <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bolder flex-nowrap">
                            ...
                            <li class="nav-item">
                                 <a class="nav-link text-active-primary me-6 {{last(request()->segments()) == 'orders'?'active':''}}" href="{{route('customers.orders', $customer->id)}}">الطلبات</a>
                            </li>

                            <li class="nav-item">
                                <a class="nav-link text-active-primary me-6 {{last(request()->segments()) == 'addresses'?'active':''}}" href="{{route('customers.addresses', $customer->id)}}">عنوان التوصيل</a>
                            </li>
