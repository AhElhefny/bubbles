                      ...
                      <div class="card-title">
                       ...
                       <div class="card-toolbar">
                           <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                 <a href="{{route('sellers.create')}}" type="button" class="btn btn-primary">
                       ...
                       <div class="card-body pt-0">
                               ...
                               <thead>
                                ...
                                <tbody class="text-gray-600 fw-bold">
                                 ...
                                 <tr>
                                    ...
                                    @if(isset($user->user))<td>{{ $user->user->mobile }}</td>@endif
                                    @if(isset($user->user))<td>{{ $user->user->email }}</td>@endif
                                    @if(isset($user->city))<td>{{ $user->city->name}}</td>@endif
                                       ...
                                       <a href="#" class="btn btn-light btn-active-light-primary btn-sm" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end" data-kt-menu-flip="top-end">{{__('admin.actions')}}
                                          ...
                                          <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                            <div class="menu-item px-3">
                                                 <a href="{{route('sellers.edit', $user->id)}}" class="menu-link px-3">{{__('admin.edit')}}</a>
                                            </div>
                                            <div class="menu-item px-3">
                                                  <a href="{{route('sellers.show', $user->id)}}" class="menu-link px-3">{{__('admin.show')}}</a>
                                            </div>
                                              <!--<div class="menu-item px-3">-->
                                                              ...
                                                              <div class="btn btn-icon btn-sm btn-active-light-primary ms-2" data-bs-dismiss="modal" aria-label="Close">
                                                                ...
                                                                <div class="modal-body text-center">
                                                                 ...
                                                                 <div class="text-center pt-15">
                                                                  ...
                                                                  {!! Form::open(['url' => route('sellers.destroy', $user->id), 'method' => 'delete']) !!}
                        ...
                        {!! $sellers->links('dashboard.partials.paginator', ['disableJS' => true]) !!}
                 </div>
            </div>
@endsection
