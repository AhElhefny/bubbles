             ...
             <div class="card card-xl-stretch mb-5 mb-xl-10">
                <div class="card-header border-0 pt-5">
                    <h3 class="card-title align-items-start flex-column">
                      ...
                      {!! Form::open(['url' => route('sellers.update', $data->id), 'method' => 'put', 'files'=>true]) !!}
...
{{--                                               <input type="number" name="number_of_branches" class="form-control form-control-solid" value="{{old('number_of_branches',$data->number_of_branches)}}" placeholder="{{__('admin.number_of_branches')}}"/>--}}
