           ...
           <div class="me-7 mb-4">
              <div class="symbol symbol-100px symbol-lg-160px symbol-fixed position-relative">
                 @if($user->avatar)
                    ...
                    <div class="bg-{{customerStatusClass($user->user->name)}} position-absolute border border-4 border-white h-15px w-15px rounded-circle translate-middle start-100 top-100 ms-n3 mt-n3"></div>
                     @else
                     @php
                       $firstLetterOfCustomer = strtoupper(substr(Str::slug($user->user->name), 0, 1));
                       $customerBgColor = randomBootstrapColorsLabel($user->user->id);
                     @endphp
                          ...
                          <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                               <div class="d-flex flex-column">
                                    ...
                                    <div class="fw-bold fs-6 mb-4 pe-2">
                                        <div class="d-flex align-items-center text-gray-400 text-hover-primary me-5 mb-11">
             ...
             <div class="card-body p-9">
                <div class="row mb-7">
                    <label class="col-lg-4 fw-bold text-muted">الاسم</label>
                       <div class="col-lg-8">
                          <span class="fw-bolder fs-6 text-gray-800">{{$user->user->name}}</span>
                       </div>
                </div>

                 <div class="row mb-7">
                    <label class="col-lg-4 fw-bold text-muted">رقم الموبايل
                    <i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" title="Phone number must be active"></i></label>
                    <div class="col-lg-8 d-flex align-items-center">
                        <span class="fw-bolder fs-6 text-gray-800 me-2">{{$user->user->mobile}}</span>
                    </div>
                </div>
                ...
                <div class="row mb-7">
                    ...
                    <div class="col-lg-8">
                         <a href="#" class="fw-bold fs-6 text-gray-800 text-hover-primary">{{$user->user->email}}</a>
                    </div>
                </div>
                 ...
                 <div class="row mb-7">
                    <label class="col-lg-4 fw-bold text-muted">المدينه</label>
                      <div class="col-lg-8">
                         <a href="#" class="fw-bold fs-6 text-gray-800 text-hover-primary">{{$user->city->name}}</a>
                     </div>
                  </div>
              </div>
         </div>
