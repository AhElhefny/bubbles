...
@section('content')
           ...
           <div class="row g-5 g-xl-8">
                <div class="col-xl-3">
                    <a class="card hoverable card-xl-stretch mb-xl-8 bg-danger">
                       <div class="card-body">
                          <span class="svg-icon svg-icon-white svg-icon-3x ms-n1">
                             <i class="fas fa-hospital text-light fs-2x"></i>
                          </span>
                            <div class="text-white fw-bolder fs-2 mb-2 mt-5">{{__('admin.washers')}}</div>
                              <div class="fw-bold text-white">{{count($washers)}}</div>
                          </div>
                       </a>
                 </div>

                 <div class="col-xl-3">
                      <a class="card  hoverable card-xl-stretch mb-xl-8 bg-info">
                         <div class="card-body">
                             <span class="svg-icon svg-icon-white svg-icon-3x ms-n1">
                               <i class="fa fa-user text-light fs-2x"></i>
                            </span>
                             <div class="text-white fw-bolder fs-2 mb-2 mt-5">{{__('admin.centers')}}</div>
                               <div class="fw-bold text-white">{{count($center_service)}}</div>
                            </div>
                        </a>
                  </div>

                  <div class="col-xl-3">
                     <a class="card hoverable card-xl-stretch mb-5 mb-xl-8 bg-primary">
                         <div class="card-body">
                            <span class="svg-icon svg-icon-white svg-icon-3x ms-n1">
                               <i class="fa fa-bed text-light fs-2x"></i>
                           </span>
                            <div class="text-white fw-bolder fs-2 mb-2 mt-5">{{__('admin.customers')}}</div>
                            <div class="fw-bold text-white">{{count($customers)}}</div>
                         </div>
                     </a>
               </div>

                <div class="col-xl-3">
                     <a class="card  hoverable card-xl-stretch mb-xl-8 bg-success">
                         <div class="card-body">
                            <span class="svg-icon svg-icon-white svg-icon-3x ms-n1">
                               <i class="fas fa-globe-africa  text-light fs-2x"></i>
                            </span>
                               <div class="text-white fw-bolder fs-2 mb-2 mt-5">{{__('admin.orders')}}</div>
                               <div class="fw-bold text-white">{{App\Models\Order::where('status',0)->count()}}</div>
                            </div>
                         </a>
                    </div>
              </div>
                      ...
                      <div class="card-body p-0">
                           <div class="mixed-widget card-rounded-bottom bg-danger" data-kt-color="danger" style="height: 200px"></div>
                                <div class="card-p mt-n20 position-relative">
                                      <div class="row g-0">
                                         <div class="col bg-light-primary px-6 py-8 rounded-2 mb-7 m-2">
                                              ...
                                              <div class="col bg-light-success px-6 py-8 rounded-2 m-2" style="height: 134px;">
                                             ...
                                             <tr>
                                                <td>
                                                  <div class="d-flex align-items-center">
                                                   ...
                                                   <td>
                                                       <div class="text-dark fw-bolder text-hover-primary d-block fs-6">{{ $order->total }}</div>
                                                   </td>
