      <div id="kt_header" style="" class="header align-items-stretch">
            ...
            <div class="d-flex align-items-stretch flex-shrink-0">
                ...
                <div class="d-flex align-items-stretch flex-shrink-0">
                    <!--begin::Search-->
                          <?php
                              $notifications =\App\Models\AdminNotification::where('seen',0)->get()->take(6);
                          ?>
                        ...
                        <div class="d-flex align-items-center ms-1 ms-lg-3">
                         ...
                         <div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px" data-kt-menu="true">
                            <div class="d-flex flex-column bgi-no-repeat rounded-top" style="background-color:#009EF7">
                                ...
                                <div class="separator my-2"></div>
                                 {{--<div class="menu-item px-5" data-kt-menu-trigger="hover" data-kt-menu-placement="left-start" data-kt-menu-flip="bottom, top">
                                      ...
                                      <div class="menu-sub menu-sub-dropdown w-175px py-4">
                                       ...
                                       <div class="menu-item px-5">
                                            <a href="{{url ('editprofile/'.auth()->user()->id)}}" class="menu-link px-5">{{__('admin.editprofile')}}</a>
                                       </div>
