                            ...
                            <div class="col-md-6">
                             ...
                             <div class="col-md-6">
                                ...
                                <div class="mb-5 {{ $errors->has('mobile') ? 'has-error' : '' }}">
                                    <input type="number" name="mobile" class="form-control form-control-solid" value="{{old('mobile',$data->mobile)}}" placeholder="{{__('admin.phone')}}"/>
                               ...
                               <!--<div class="col-md-6">
                                  <label class="form-label fs-6 fw-bolder text-gray-700 mb-3">{{__('admin.code')}}</label>
                                    <div class="mb-5 {{ $errors->has('route_code') ? 'has-error' : '' }}">
                                       <input type="text" name="route_code" class="form-control form-control-solid" value="{{old('route_code',$data->route_code)}}" placeholder="{{__('admin.code')}}"/>
                                       <span class="text-danger">{{ $errors->first('route_code') }}</span>
                                   </div>
                             </div>!-->
